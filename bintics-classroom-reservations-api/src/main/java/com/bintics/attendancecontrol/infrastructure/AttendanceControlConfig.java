...
public class AttendanceControlConfig {
    ...
    @Bean
    public RegisterAttendanceUseCase registerAttendanceUseCase(ClientRepository clientRepository, SubscriptionRepository subscriptionRepository, AttendanceRepository attendanceRepository) {
